...
{   
	...
	*/
	struct ImageState
	{
		...
		// static ImageState fromChunk4backward(char*& chunk, int num_tiles);
	};
	...
	*/
	...
	// size_t ImageState_required4backward(int num_tiles)
	// {
	// 	char* size = nullptr; // 即地址为 0
	// 	ImageState::fromChunk4backward(size, num_tiles);
	// 	return ((size_t)size) + 128;
	// }
};