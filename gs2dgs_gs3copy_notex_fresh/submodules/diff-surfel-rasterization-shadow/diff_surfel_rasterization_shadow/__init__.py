...
class GaussianRasterizationSettings(NamedTuple):
    ...
    texture_shadow_use_alpha: bool = False
    texture_shadow_output_uv: bool = True
    texture_shadow_alpha_bilinear: bool = False
...
def rasterize_gaussians(
    ...
    args = (
        ...
        thres,
        is_train,
        raster_settings.texture_shadow_use_alpha,
        raster_settings.texture_shadow_output_uv,
        raster_settings.texture_shadow_alpha_bilinear,
    )
...
class GaussianRasterizer(nn.Module):
    ...
    def forward(
        ...
        if non_trans is None:
            ...
            if not self.raster_settings.texture_shadow_output_uv:
                shadow_size = means3D.shape[0]
