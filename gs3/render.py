        ...
        if aaai_render:
            ...
            if modelset.use_nerual_phasefunc:
                ...
                if os.path.exists(_model_path):
                    ...
                    (model_params, first_iter) = torch.load(_model_path, weights_only=False)
...
if __name__ == "__main__":
    ...
    render_sets(mp.extract(args), args.load_iteration, pp.extract(args), \
                ...
                args.force_save, args.aaai_render, args.beijing_render, args.synthesize_video, args.shadowmap_render)